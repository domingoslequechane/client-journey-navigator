...
import { Plus, Filter, Search, Target, FileCheck, Phone } from 'lucide-react';
...
export default function SalesFunnel() {
  ...
  const salesFunnelClients = clients.filter(c => ['prospecting', 'qualification', 'closing'].includes(c.stage));

  const getClientsByStage = (stageId: string) => salesFunnelClients.filter(client => client.stage === stageId);
