...
const comparisonFeatures = [
  {
    ...
    features: [
      { name: 'Número de clientes', free: '5', starter: '15', pro: '50', agency: 'Ilimitado' },
  ...
  },
  {
    ...
    features: [
      { name: 'Contratos por mês', free: '2', starter: '10', pro: 'Ilimitado', agency: 'Ilimitado' },
      ...
      { name: 'Personalização avançada', free: false, starter: false, pro: true, agency: true },
    ],
  },
  {
    category: 'Inteligência Artificial',
    features: [
      { name: 'Mensagens IA por mês', free: '10', starter: '50', pro: 'Ilimitado', agency: 'Ilimitado' },
      { name: 'Assistente de estratégia', free: true, starter: true, pro: true, agency: true },
      { name: 'Análise de cliente', free: false, starter: true, pro: true, agency: true },
      { name: 'Sugestões personalizadas', free: false, starter: false, pro: true, agency: true },
    ],
  },
  {
    category: 'Equipe & Colaboração',
    features: [
      { name: 'Usuários inclusos', free: '1', starter: '2', pro: '5', agency: '15' },
      { name: 'Papéis e permissões', free: false, starter: true, pro: true, agency: true },
      { name: 'Auditoria de ações', free: false, starter: false, pro: true, agency: true },
      { name: 'Gestão de equipe', free: false, starter: true, pro: true, agency: true },
    ],
  },
  {
