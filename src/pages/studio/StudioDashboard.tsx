...
import { LayoutGrid, FolderRoot } from 'lucide-react';
  ...
  return (
    <div className="w-full p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button onClick={() => navigate('/app/studio/new')} className="gap-2 shadow-sm">
          <Plus className="h-4 w-4" />
          Novo Projeto de Flyer
        </Button>
      </div>
      ...
      <Tabs defaultValue="tools" className="w-full">
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="projects" className="gap-2">
            ...
            Meus Projetos
            {projects.length > 0 && (
              <Badge variant="secondary" className="ml-1 h-5 px-1 min-w-[20px]">{projects.length}</Badge>
            )}
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="projects" className="outline-none space-y-6">
          ...
          {projectsLoading ? (
            ...
            <div className="text-center py-20 border rounded-xl bg-muted/5">
              ...
              {searchQuery ? (
                <>
                  ...
                  <p className="text-muted-foreground mt-1">
                    Tente uma pesquisa diferente para seus projetos de flyer
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p className="text-muted-foreground mt-1 mb-4">
                    Crie seu primeiro projeto para começar a gerar flyers em lote
                  </p>
