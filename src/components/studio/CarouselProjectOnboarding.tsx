...
interface CarouselProjectOnboardingProps {
...
export function CarouselProjectOnboarding({ onComplete, onCancel, projectId }: CarouselProjectOnboardingProps) {
    ...
    <div className="flex h-full md:h-screen bg-background relative overflow-hidden w-full">
      ...
      <div className="space-y-4 mb-12 text-center">
        ...
        <h1 className="text-4xl font-black tracking-tighter">
          {projectId ? 'Editar Identidade de Marca (v2)' : 'Criar Nova Identidade de Carrossel (v2)'}
        </h1>
            ...
            <div className="space-y-6">
              <div className="p-4 bg-primary/5 border border-primary/10 rounded-2xl space-y-2">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Essas regras serão seguidas rigorosamente pela nossa equipe de agentes (Copywriter, Designer, Revisor) em cada geração.
                </p>
              </div>
