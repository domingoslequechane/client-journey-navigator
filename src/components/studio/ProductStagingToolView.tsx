                ...
                >
                    ...
                    <div className="absolute inset-x-0 bottom-8 md:bottom-12 flex justify-center px-6 z-[110] pointer-events-none">
                        <div className="pointer-events-auto flex items-center gap-4 animate-in slide-in-from-bottom-8 duration-500">
                            <Button size="lg" onClick={(e) => { e.stopPropagation(); setMaximizedImage(null); handleReuseGenerated(maximizedImage); }} className="h-12 px-6 rounded-2xl bg-primary hover:bg-primary/90 text-white shadow-xl font-bold transition-all active:scale-95">
                                <Upload className="h-4 w-4 mr-2" /> Novo Cenário
                            </Button>
