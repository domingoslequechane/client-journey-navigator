...
export function ProductStagingToolView({ tool }: ProductStagingToolViewProps) {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const finalPrompt = `${userPrompt}. Realistic environment product staging, lifestyle photography, natural home lighting, high-end interior design background, 8k resolution, cinematic lighting, photorealistic`;
                            ...
                            {previewUrl ? (
                                <div className="flex items-center gap-4 w-full px-2">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-bold text-foreground truncate">Produto Selecionado</p>
