-- Migration to align plan_limits with the new pricing page structure
...
UPDATE public.plan_limits SET
  ...
  max_studio_generations = 1800, -- 60/day * 30
...
UPDATE public.plan_limits SET
  ...
  has_studio_module = true, -- Studio is available on free plan
